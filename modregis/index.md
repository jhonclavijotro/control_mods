...
2. [[01 - Guía de Instalación y Despliegue]]
   - Requisitos, despliegue con Docker, uso del `Makefile`, entorno virtual local y túneles seguros con ngrok.
3. [[02 - Manual de Usuario y Operaciones]]
   - Guía de uso del Dashboard, operaciones en tarjetas de módulos, regla de diagnóstico obligatorio y modo solo lectura para stakeholders.
...
# Iniciar entorno Administrador (Puerto 8000)
make up

# Iniciar entorno de Solo Lectura para Stakeholders (Puerto 8001)
make stakeholder
